...
function fmt(e) {
  return { id: e.id, userId: e.user_id, studentName: e.student_name, type: e.type, score: e.score, feedback: e.feedback, criteria: e.criteria, profileName: e.profile_name, turma: e.turma, exerciseName: e.exercise_name, institution: e.institution, disciplina: e.disciplina || '', studentId: e.student_id || null, classId: e.class_id || null, createdAt: e.created_at };
}
