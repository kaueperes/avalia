...
function fmt(e) {
  return { id: e.id, userId: e.user_id, name: e.name, type: e.type, disciplina: e.disciplina || '', context: e.context, criteria: e.criteria, disciplineId: e.discipline_id || null, createdAt: e.created_at };
}
...
export async function PUT(request, { params }) {
  ...
  const { data: e, error } = await supabase.from('exercises')
    .update({ name, type, disciplina: disciplina || '', context: context || '', criteria: criteria || [], discipline_id: disciplineId || null })
