              ...
              <div className="grid-plans" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, alignItems: 'start' }}>
                ...
                <div className="plan-card" style={{ background: '#00173f', border: '1px solid #00173f', position: 'relative', transform: 'scale(1.03)' }}>
                  ...
                  <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 24, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {['120 avaliações/mês', '4 perfis de avaliação', 'Exercícios ilimitados', 'Avaliação individual', 'Avaliação em lote', 'Histórico de avaliações', 'PDF de avaliação', 'Exportação CSV', 'Gerador de Provas (10/mês)', 'Chatbot (50 msg)'].map(item => (
                ...
                <div className="plan-card" style={{ background: 'white', border: '1px solid #E5E7EB' }}>
                  ...
                  <div style={{ borderTop: '1px solid #F3F4F6', paddingTop: 24, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {['180 avaliações/mês', '6 perfis de avaliação', 'Exercícios ilimitados', 'Avaliação individual', 'Avaliação em lote', 'Histórico de avaliações', 'PDF de avaliação', 'Exportação CSV', 'Relatórios avançados (10/mês)', 'Gerenciamento de relatórios', 'PDF de relatórios', 'Gerador de Provas (10/mês)', 'Chatbot (150 msg)'].map(item => (
                      <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 13, color: '#374151' }}>
                        <CheckMark /> {item}
                      </div>
                    ))}
                ...
                <div className="plan-card" style={{ background: 'white', border: '2px solid #d97706' }}>
                  ...
                  <div style={{ borderTop: '1px solid #F3F4F6', paddingTop: 24, display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {['240 avaliações/mês', '10 perfis de avaliação', 'Exercícios ilimitados', 'Avaliação individual', 'Avaliação em lote', 'Histórico de avaliações', 'PDF de avaliação', 'Exportação CSV', 'Relatórios avançados (30/mês)', 'Gerenciamento de relatórios', 'PDF de relatórios', 'Gerador de Provas (10/mês)', 'Chatbot (300 msg)', 'Suporte prioritário'].map(item => (
                      <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 13, color: '#374151' }}>
