  ...
  return (
    <AppLayout userName={userName}>
      ...
      <div style={{ background: 'var(--bg-card)', borderRadius: 14, border: '1px solid var(--border-card)', padding: '24px 28px', marginBottom: 28 }}>
        ...
        <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: '1fr auto auto auto', gap: 10, alignItems: 'end' }}>
          <div>
          ...
          {orgs.length === 0 ? (
            ...
            orgs.map(org => (
              <div key={org.id} style={{ borderTop: '1px solid var(--border)', padding: '16px 24px' }}>
                {editing?.id === org.id ? (
                  <div>
                    <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: 10, alignItems: 'center', marginBottom: 10 }}>
                    ...
                    <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
                      <div>
                ...
                {addingQuota?.id === org.id && (
                  <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto auto', gap: 10, alignItems: 'center', marginTop: 14, paddingTop: 14, borderTop: '1px dashed var(--border)' }}>
                ...
                {settingAdmin?.id === org.id && (
                  <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: 10, alignItems: 'center', marginTop: 14, paddingTop: 14, borderTop: '1px dashed var(--border)' }}>
                    <div>
