        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ background: '#F0F9FF', borderRadius: 14, padding: '20px 24px', marginBottom: 48, border: '1px solid #BAE6FD', display: 'flex', gap: 12 }}>
            ...
            <p style={{ fontSize: 14, color: '#0369A1', lineHeight: 1.65, margin: 0 }}>
              Esta política descreve como o AvaliA coleta, usa e protege suas informações. Nos comprometemos a manter seus dados seguros e a ser transparentes sobre como os utilizamos.
            </p>
          </div>

          <Section title="1. Quem somos">
            <P>O AvaliA é uma plataforma SaaS de avaliação educacional com inteligência artificial, desenvolvida para auxiliar professores na correção e análise de trabalhos de alunos.</P>
          ...
          <Section title="3. Dados dos alunos">
            ...
            <P>O AvaliA não coleta nomes completos, documentos, dados biométricos ou qualquer dado sensível de alunos. Os resultados das avaliações (notas e feedbacks) são salvos associados apenas ao professor responsável.</P>
