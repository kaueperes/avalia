...
const PLANS = [
  ...
  },
  {
    ...
    price: 'R$ 29/mês',
    color: '#2563eb',
    features: ['300 avaliações/mês', '4 perfis de professor', 'Exercícios ilimitados', 'PDF + CSV', 'Gerador de Provas (10/mês)', 'Chatbot (50 msgs/mês)'],
  },
  {
    id: 'pro',
    label: 'Pro',
    price: 'R$ 59/mês',
    color: '#7c3aed',
    features: ['450 avaliações/mês', '6 perfis de professor', 'Exercícios ilimitados', 'PDF + CSV', '10 relatórios/mês', 'Gerador de Provas (10/mês)', 'Chatbot (150 msgs/mês)'],
  },
  {
    id: 'premium',
    label: 'Premium',
    price: 'R$ 119/mês',
    color: '#d97706',
    features: ['600 avaliações/mês', '10 perfis de professor', 'Exercícios ilimitados', 'PDF + CSV', '30 relatórios/mês', 'Gerador de Provas (10/mês)', 'Chatbot (300 msgs/mês)', 'Suporte prioritário'],
  },
];
