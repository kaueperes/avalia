        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ background: '#FFFBEB', borderRadius: 14, padding: '20px 24px', marginBottom: 48, border: '1px solid #FDE68A', display: 'flex', gap: 12 }}>
            ...
            <p style={{ fontSize: 14, color: '#92400E', lineHeight: 1.65, margin: 0 }}>
              Ao criar uma conta e usar o AvaliA, você concorda com estes termos. Leia com atenção antes de utilizar a plataforma.
            </p>
          </div>

          <Section title="1. Descrição do serviço">
            <P>O AvaliA é uma plataforma de avaliação educacional que utiliza inteligência artificial para auxiliar professores na correção de trabalhos e análise do desempenho de turmas.</P>
          ...
          <Section title="2. Elegibilidade">
            <P>Para usar o AvaliA você deve:</P>
          ...
          <Section title="3. Uso aceitável">
            <P>Você concorda em usar o AvaliA apenas para fins educacionais legítimos. É <strong>proibido</strong>:</P>
            <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
          ...
          <Section title="4. Planos e pagamentos">
            <P>O AvaliA oferece um plano gratuito com recursos limitados e planos pagos com funcionalidades adicionais. Os preços e limites de cada plano estão disponíveis na página de planos.</P>
          ...
          <Section title="6. Propriedade intelectual">
            <P>O AvaliA e todo o seu conteúdo (código, design, textos, marca) são propriedade de seus criadores e protegidos por leis de propriedade intelectual.</P>
          ...
          <Section title="7. Disponibilidade do serviço">
            <P>Buscamos manter o AvaliA disponível 24/7, mas não garantimos disponibilidade ininterrupta. Manutenções programadas serão comunicadas com antecedência quando possível.</P>
            <P>Não nos responsabilizamos por perdas decorrentes de indisponibilidade temporária do serviço.</P>
          </Section>

          <Section title="8. Limitação de responsabilidade">
            <P>O AvaliA é uma ferramenta de apoio pedagógico. Os feedbacks e notas gerados pela IA são sugestões e não substituem o julgamento profissional do professor.</P>
