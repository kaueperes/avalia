...
export default function ExerciciosPage() {
  ...
  return (
    <AppLayout userName={userName}>
      ...
      <div className="grid-collapse" style={{ display: 'grid', gridTemplateColumns: exercises.length > 0 ? '1fr 1.2fr' : '1fr', gap: 24, alignItems: 'start', minWidth: 0, overflow: 'hidden' }}>
        ...
        <div style={{ background: 'var(--bg-card)', borderRadius: 14, border: '1px solid var(--border-card)', padding: '28px 28px' }}>
          ...
          <div className="form-grid">
            ...
            <Field label="Tipo de Trabalho" tooltip="Define a categoria do trabalho. O Kriteria usa isso para escolher os critérios certos de avaliação.">
              ...
              >
                <span>{TYPES[form.type]?.label || form.type}</span>
