    ...
    return (
      <AppLayout userName={userName}>
        ...
        <div style={{ background: 'var(--bg-card)', borderRadius: 14, border: '1px solid var(--border-card)', padding: '48px', textAlign: 'center' }}>
          ...
          <button onClick={() => router.push('/avaliar-basica')} style={{ padding: '11px 28px', background: '#0081f0', color: 'white', border: 'none', borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
