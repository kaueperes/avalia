      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(14px)', borderBottom: '1px solid rgba(0,0,0,0.07)', padding: '0 32px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            ...
            <a href="/portfolio/contato" style={{ background: '#0081f0', color: 'white', borderRadius: 8, padding: '8px 16px', fontSize: 13, fontWeight: 600, textDecoration: 'none' }}>Contato</a>
          </div>
        </div>
      </nav>
      ...
      <section id="contato" style={{ padding: '80px 32px', background: 'linear-gradient(145deg, #0a0c18 0%, #0d1230 60%, #1a0530 100%)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 600, margin: '0 auto', position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/portfolio/contato" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'linear-gradient(135deg, #0081f0, #810cfa)', color: 'white', borderRadius: 12, padding: '14px 32px', fontSize: 15, fontWeight: 600, textDecoration: 'none' }}>
              ✉ Entrar em contato
            </a>
