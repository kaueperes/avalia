...
export const TYPES = {
  ...
  rigging:        { label:'Rigging',               icon:'🦴', cat:'3d',     input:'video',
  ...
  storyboard:     { label:'Storyboard',            icon:'🎬', cat:'visual',  input:'imgs',
  ...
  musica_partitura:{ label:'Partitura',            icon:'🎵', cat:'texto',   input:'imgs',
  ...
  libras:         { label:'Libras',                icon:'🤟', cat:'outros',  input:'video',
