...
export const TYPES = {
  ...
  modelagem:      { label:'Modelagem 3D',         icon:'⬡', cat:'3d',     input:'obj',
    hint: 'Envie o arquivo .obj (topologia, vértices e faces) e/ou imagens de render — combinando os dois a avaliação fica mais completa.',
  ...
  animacao:       { label:'Animação 3D',           icon:'▶', cat:'3d',     input:'img',
    hint: 'Envie screenshots ou frames exportados mostrando o movimento, poses-chave e arcos da animação.',
