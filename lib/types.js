...
export const TYPES = {
  ...
  tcc:            { label:'TCC / Monografia',      icon:'📚', cat:'texto',   input:'text',
    hint: 'Cole o texto ou envie como .docx. Para avaliar formatação ABNT (margens, espaçamento, capa), envie prints das páginas como imagem — a IA analisa visualmente.',
